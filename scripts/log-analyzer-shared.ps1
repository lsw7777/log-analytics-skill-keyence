...
| extend MailboxType = tostring(column_ifexists("MailboxType", ""))
| extend RecipientType = tostring(column_ifexists("RecipientType", ""))
| extend __sharedFlagText = tostring(column_ifexists("IsSharedMailbox", ""))
...
| extend __availableText = tostring(column_ifexists("AvailableSpaceGB", ""))
| extend __quotaText = tostring(column_ifexists("QuotaLimitGB", ""))
